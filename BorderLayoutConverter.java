...
public class BorderLayoutConverter extends JFrame {
    ...
    public BorderLayoutConverter() {
        ...
        add(southPanel, BorderLayout.SOUTH); binaryBtn.addActionListener(e -> convert("binary"));
    ...
    private void convert(String type) {
        try {
            ...
            switch (type) {
                case "binary":                    resultField.setText(Integer.toBinaryString(number));
                    break;
                case "octal":                    resultField.setText(Integer.toOctalString(number));
                    break;
                case "hex":                    resultField.setText(Integer.toHexString(number).toUpperCase());
                    break;
            }
