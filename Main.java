...
public void withdraw(double amount) 
{if (getBalance() - amount < 100) {System.out.println("Withdrawal denied: 
...
BankAccount(initialBalance); 
        ...
        System.out.print("Enter withdrawal amount for 
BankAccount: "); 
        myAccount.withdraw(scanner.nextDouble()); 
        System.out.println("Current Balance: " + myAccount.getBalance()); 
 
        System.out.print("Enter initial balance for SavingsAccount: ");         initialBalance = scanner.nextDouble(); 
        SavingsAccount mySavingsAccount = new 
SavingsAccount(initialBalance); 
        ...
        System.out.print("Enter first withdrawal amount for SavingsAccount: "); mySavingsAccount.withdraw(scanner.nextDouble()); 
